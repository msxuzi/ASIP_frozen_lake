...
gamma = 0.5             # współczynnik dyskontowania (discount factor)
epsilon_max = 0.3        # początkowa wartość epsilon
epsilon_min = 0.01       # minimalna wartość epsilon (dla końca treningu)
num_episodes = 10000     # liczba epizodów treningowych
max_steps = 200          # maksymalna liczba kroków w epizodzie
q_table_file = "q_table_3.csv"  # nazwa pliku do zapisu Q-tabeli
...
for episode in range(num_episodes):
    ...
    epsilon = epsilon_min + (epsilon_max - epsilon_min) * (1 - episode / num_episodes)
